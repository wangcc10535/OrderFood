<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="0不显示  1 显示 " prop="enable">
        <el-input
          v-model="queryParams.enable"
          placeholder="请输入0不显示  1 显示 "
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="typeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="门店" align="center" prop="shopId" />
      <el-table-column label="是否显示" align="center" prop="enable" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="菜品种类" prop="name">
          <el-input v-model="form.name" placeholder="请输入菜品种类" />
        </el-form-item>
        <el-form-item label="${comment}" prop="shopId">
          <el-input v-model="form.shopId" placeholder="请输入${comment}" />
        </el-form-item>
        <el-form-item label="是否显示 " prop="enable">
          <el-input v-model="form.enable" placeholder="请输入是否显示" />
        </el-form-item>
      </el-form>
